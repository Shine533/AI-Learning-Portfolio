...
### 🚀 Featured Projects (Highlight for Interviews)
...
| **3. 30-Day AI Tools Practice** | `ChatGPT`, `DeepSeek`, `Doubao`, `Coze`, `Qwen` | Completed 30 daily tasks covering SEO, social media promotion, and data analysis. Produced workflows and custom Skills. See details in [`ai_tools_practice/`]. |
...
│   ├── README.md
│   ├── day01_electrical_chatgpt_keywords.md
│   └── day02_alsontech-en-homepage-seo-audit.md
...
*“I don't just write code; I build solutions that speak the language of business.”*
